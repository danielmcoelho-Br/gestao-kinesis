import { DashboardStats, PatientProfileStats, StratifiedAgeRow } from "@/types";

/**
 * Serviço centralizado para cálculos e processamento de estatísticas.
 * Evita duplicação de lógica entre Dashboard e relatórios específicos.
 */
