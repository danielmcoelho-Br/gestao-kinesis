          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'center' }}>
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', alignItems: 'center' }}>
              ...
              <select 
                ...
                style={{ padding: '12px 24px', borderRadius: '12px', border: '2px solid var(--primary)', background: 'var(--bg-color)', color: 'var(--text-primary)', fontSize: '1.2rem', fontWeight: '600', cursor: 'pointer' }}
              >
                {Array.from({ length: 2026 - 2019 + 1 }, (_, i) => 2026 - i).map(year => (
            ...
            {selectedYear <= 2024 && (
              <div style={{ padding: '12px 20px', borderRadius: '12px', background: 'rgba(59, 130, 246, 0.08)', color: '#1e40af', fontSize: '0.95rem', fontWeight: '500', border: '1px solid rgba(59, 130, 246, 0.15)', maxWidth: '600px', textAlign: 'center', lineHeight: '1.4' }}>
                💡 <strong>Segmentação Automática Ativa:</strong> Para os anos de 2019 a 2024, você pode fazer o upload de apenas um arquivo consolidado em qualquer mês. O sistema distribuirá automaticamente os dados mês a mês.
              </div>
            )}
          </div>
        </div>
